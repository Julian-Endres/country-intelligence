...
INDICATORS = [
    ...
    },
    {
        ...
        "classif1_keep": ["STE_AGGREGATE_TOTAL"],
    },
    {
    ...
    {
        "code":          "ILO:HOW_TEMP_SEX_ECO_NB",
        "ilo_id":        "HOW_TEMP_SEX_ECO_NB_A",
        "name":          "Hours actually worked per week (millions of hours)",
        "unit":          "millions of hours",
        "category":      "economy",
        "description":   "Hours actually worked per week by sex and economic activity (survey-based). Total economy. Source: ILOSTAT.",
        "classif1_keep": ["ECO_ISIC4_TOTAL"],
    },
]
