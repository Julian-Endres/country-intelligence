...
indicators = [
    # Labor: Youth
    "SL.EMP.1524.SP.ZS", "SL.EMP.1524.SP.FE.ZS", "SL.EMP.1524.SP.MA.ZS",
    "SL.UEM.1524.ZS", "SL.UEM.1524.FE.ZS", "SL.UEM.1524.MA.ZS",

    # Labor: Sectors
    "SL.AGR.EMPL.ZS", "SL.AGR.EMPL.FE.ZS", "SL.AGR.EMPL.MA.ZS",
    "SL.IND.EMPL.ZS", "SL.IND.EMPL.FE.ZS", "SL.IND.EMPL.MA.ZS",
    "SL.SRV.EMPL.ZS", "SL.SRV.EMPL.FE.ZS", "SL.SRV.EMPL.MA.ZS",

    # Labor: Type
    "SL.EMP.SELF.ZS", "SL.EMP.MPYR.ZS", "SL.EMP.WORK.ZS",
    ...
    # Remittances
    "BX.TRF.PWKR.CD.DT", "BX.TRF.PWKR.DT.GD.ZS", "BM.TRF.PWKR.CD.DT",

    # Water
    "ER.H2O.INTR.PC", "ER.H2O.FWST.ZS",

    # Urban
    "EN.POP.SLUM.UR.ZS",

    # ICT
    "IT.NET.SECR.P6", "IT.NET.USER.ZS",
]
...
print(f"Lade {len(indicators)} WB Wrap-up-Indikatoren ({DATE_RANGE})...")
print("-" * 60)
